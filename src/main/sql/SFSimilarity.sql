...
RETURNS float
LANGUAGE java
IMPORTS = ('@udfstage/commons-text-1.9.jar', '@udfstage/commons-lang3-3.12.0.jar', '@udfstage/sfsimilarity-1.0.jar')
...
RETURNS integer
LANGUAGE java
IMPORTS = ('@udfstage/commons-text-1.9.jar', '@udfstage/sfsimilarity-1.0.jar')
